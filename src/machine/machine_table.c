...
const machine_t machines[] = {
    ...
    { "[i430NX] Gateway 2000 Plato",		"gw2kpci2",		MACHINE_TYPE_SOCKET5,		CPU_PKG_SOCKET5_7, 0, 50000000, 66666667, 3520, 3520, 1.5, 1.5,							MACHINE_PCI | MACHINE_BUS_PS2 | MACHINE_IDE_DUAL,				 2048, 131072, 2048, 127,	     machine_at_gw2kpci2_init, NULL			},
    ...
    { "[i430FX] Gateway 2000 Zappa",		"gw2kzp",		MACHINE_TYPE_SOCKET5,		CPU_PKG_SOCKET5_7, 0, 50000000, 66666667, 3380, 3520, 1.5, 2.0,							MACHINE_PCI | MACHINE_BUS_PS2 | MACHINE_IDE_DUAL,				 8192, 131072, 8192, 127,	       machine_at_gw2kzp_init, NULL			},
    ...
    { "[i430TX] Gateway 2000 Mailman",		"gw2kma",		MACHINE_TYPE_SOCKET7,	        CPU_PKG_SOCKET5_7, 0, 50000000, 66666667, 2800, 3520, 1.5, 3.0,							MACHINE_PCI | MACHINE_BUS_PS2 | MACHINE_IDE_DUAL,		 		 8192, 131072, 8192, 127,	       machine_at_gw2kma_init, NULL			},
#if defined(DEV_BRANCH) && defined(NO_SIO)
    ...
    { "[i440FX] Gateway 2000 Venus",		"gw2kvs",		MACHINE_TYPE_SOCKET8,		CPU_PKG_SOCKET8, 0, 60000000, 66666667, 2100, 3500, 2.5, 3.0,							MACHINE_PCI | MACHINE_BUS_PS2 | MACHINE_IDE_DUAL,				 8192, 524288, 8192, 127,	       machine_at_gw2kvs_init, NULL			},
