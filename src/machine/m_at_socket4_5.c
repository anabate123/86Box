...
machine_at_gw2kpci2_init(const machine_t *model)
{
    ...
    ret = bios_load_linear_combined(L"roms/machines/gw2kpci2/1012ax1t.bio",
				    L"roms/machines/gw2kpci2/1012ax1t.bi1", 0x1d000, 128);
...
machine_at_gw2kzp_init(const machine_t *model)
{
    ...
    ret = bios_load_linear_combined(L"roms/machines/gw2kzp/1011bs0t.bio",
				    L"roms/machines/gw2kzp/1011bs0t.bi1", 0x20000, 128);
